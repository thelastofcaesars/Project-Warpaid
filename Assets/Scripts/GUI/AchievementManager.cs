...
public class AchievementManager : MonoBehaviour
{
    ...
    static public void NotifyAchievementManager(Item item)
    {
        ...
        if (item.itemType == Item.eItemType.Letter)
        {
            AchievementStep(Achievement.eStepType.letterCollected, 1);
        }
        else if (item.itemType == Item.eItemType.Ammo)
        {
            AchievementStep(Achievement.eStepType.ammoCollected, 1);
        }
    }
}
/// <summary>
...
public class Achievement
{
    ...
    //public UnityEngine.UI.Image image; // The image of the Achievement Pop-Up
